...
<p align="center">
  <img src="doc/architecture.zh.svg" alt="AgentWorld Async 架构图" width="960">
</p>
...
<p align="center">
  <img src="doc/npc-pipeline.zh.svg" alt="NPC 代理循环管道" width="960">
</p>

每个 NPC 运行独立的异步循环，每轮经过七个阶段。LLM 仅在**阶段 3（决策）**被调用，且仅当阶段 2（门控）检测到 agent 感知发生有意义的变化时才触发。
